<template>
    <div class="md-layout md-alignment-center" style="margin: 5rem 0;">
        <div class="md-layout-item md-size-75 md-small-size-80 md-xsmall-size-100">
            ...
            <form
                ...
                <md-field>
                    ...
                    <md-textarea
                        v-model="text"
                        :disabled="loading || !user"></md-textarea>
                ...
                <md-button 
                    ...
                    >Submit Comment</md-button>
            </form>
            
            <!-- comments -->
            <md-list class="md-triple-line" style="margin-top: 1rem;">
                <md-list-item
                    v-for="comment in headline.comments"
                    :key="comment.id">
                    <md-avatar>
                    ...
                    <md-badge class="md-primary" md-position="bottom" :md-content="comment.likes"></md-badge>
                        <md-button 
